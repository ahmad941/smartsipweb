    ...
    <div class="space-y-5">
        ...
        <nav class="space-y-1.5 pt-1">
            ...
            <a href="{{ route('schools.index') }}" 
                x-show="!sidebarSearch || 'sekolah mitra schools'.includes(sidebarSearch.toLowerCase())"
                class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all group
                ...
                <span x-show="!sidebarCollapsed" class="truncate">Master Sekolah</span>
            </a>

            <!-- 5. Master Kelas -->
            <a href="{{ Route::has('admin.classes.index') ? route('admin.classes.index') : '#' }}" 
                x-show="!sidebarSearch || 'master kelas classes'.includes(sidebarSearch.toLowerCase())"
                class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all group
                    {{ request()->routeIs('admin.classes.*') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/25' : 'text-slate-600 hover:bg-slate-100/70 hover:text-slate-900' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                </svg>
                <span x-show="!sidebarCollapsed" class="truncate">Master Kelas</span>
            </a>
